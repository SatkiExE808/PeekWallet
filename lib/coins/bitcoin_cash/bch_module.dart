...
class BitcoinCashModule implements CoinModule {
  const BitcoinCashModule();
  ...
  @override
  String get symbol => 'BCH';
  @override
  Color get color => const Color(0xFF0AC18E);
  @override
    ...
    switch (format) {
      ...
      default:
        throw CoinModuleError(
            'BCH doesn\'t support ${format.displayName} for create');
    }
  ...
  Future<RestoredWalletMaterial> restoreFrom({
    ...
    if (format != SeedFormat.bip39_12 && format != SeedFormat.bip39_24) {
      throw CoinModuleError(
          'BCH doesn\'t support ${format.displayName} for restore');
    }
